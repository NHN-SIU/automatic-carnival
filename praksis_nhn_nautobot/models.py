...
class Samband(PrimaryModel):
    ...
    name_prefix = models.CharField(max_length=10, null=True, blank=True, help_text="Prefix for the connection name")
    type = models.CharField(max_length=50, null=True, blank=True, help_text="Type of connection")
    type_id = models.IntegerField(null=True, blank=True, help_text="Identifier for connection type")
    status = models.CharField(max_length=50, null=True, blank=True, help_text="Current status of connection")
    status_id = models.IntegerField(null=True, blank=True, help_text="Identifier for connection status")

    # Location Information
    location = models.CharField(max_length=100, null=True, blank=True, help_text="Physical location name")
    location_id = models.IntegerField(null=True, blank=True, help_text="Location identifier")
    location_type = models.CharField(
        max_length=50, null=True, blank=True, help_text="Type of location (e.g., Office, Data Center)"
    )

    # Point of Presence A
    pop_a_address_string = models.CharField(
        max_length=200, null=True, blank=True, help_text="Physical address of Point of Presence A"
    )
    pop_a_category = models.CharField(max_length=50, null=True, blank=True, help_text="Category of Point of Presence A")
    pop_a_geo_string = models.CharField(
        max_length=50, null=True, blank=True, help_text="Geographic coordinates of Point of Presence A"
    )
    pop_a_map_url = models.URLField(null=True, blank=True, help_text="Map URL for Point of Presence A")
    pop_a_room = models.CharField(
        max_length=50, null=True, blank=True, help_text="Room identifier for Point of Presence A"
    )

    # Point of Presence B
    pop_b_address_string = models.CharField(
        max_length=200, null=True, blank=True, help_text="Physical address of Point of Presence B"
    )
    pop_b_category = models.CharField(max_length=50, null=True, blank=True, help_text="Category of Point of Presence B")
    pop_b_geo_string = models.CharField(
        max_length=50, null=True, blank=True, help_text="Geographic coordinates of Point of Presence B"
    )
    pop_b_map_url = models.URLField(null=True, blank=True, help_text="Map URL for Point of Presence B")
    pop_b_room = models.CharField(
        max_length=50, null=True, blank=True, help_text="Room identifier for Point of Presence B"
    )
    ...
    bandwidth_string = models.CharField(
        max_length=20, null=True, blank=True, help_text="Bandwidth representation (e.g., '100 Mbps')"
    )
    ...
    sambandsnummer = models.CharField(
        max_length=20, unique=True, null=True, blank=True, help_text="Connection reference number"
    )
    smbnr_nhn = models.CharField(
        max_length=20, unique=True, null=True, blank=True, help_text="NHN connection reference number"
    )
    ...
    smbnr_prefix = models.CharField(
        max_length=5, null=True, blank=True, help_text="Prefix for connection reference number"
    )
    ...
    # Vendor Information
    vendor = models.CharField(max_length=100, null=True, blank=True, help_text="Vendor providing the connection")
    ...
    transporttype = models.CharField(max_length=50, null=True, blank=True, help_text="Type of transport connection")
