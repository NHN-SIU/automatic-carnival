...
- `project_name`: the default docker compose project name (default: `praksis-nhn-nautobot`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_PRAKSIS_NHN_NAUTOBOT_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/praksis-nhn-nautobot/nautobot:2.0.0-py3.11 done
```
...
Creating network "praksis_nhn_nautobot_default" with the default driver
Creating volume "praksis_nhn_nautobot_postgres_data" with default driver
Creating praksis_nhn_nautobot_redis_1 ...
Creating praksis_nhn_nautobot_docs_1  ...
Creating praksis_nhn_nautobot_postgres_1 ...
Creating praksis_nhn_nautobot_postgres_1 ... done
Creating praksis_nhn_nautobot_redis_1    ... done
Creating praksis_nhn_nautobot_nautobot_1 ...
Creating praksis_nhn_nautobot_docs_1     ... done
Creating praksis_nhn_nautobot_nautobot_1 ... done
Creating praksis_nhn_nautobot_worker_1   ...
Creating praksis_nhn_nautobot_worker_1   ... done
...
ee90fbfabd77   praksis-nhn-nautobot/nautobot:2.0.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               praksis_nhn_nautobot_worker_1
b8adb781d013   praksis-nhn-nautobot/nautobot:2.0.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   praksis_nhn_nautobot_nautobot_1
d64ebd60675d   praksis-nhn-nautobot/nautobot:2.0.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   praksis_nhn_nautobot_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   praksis_nhn_nautobot_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   praksis_nhn_nautobot_redis_1
```
...
Stopping praksis_nhn_nautobot_worker_1   ...
Stopping praksis_nhn_nautobot_nautobot_1 ...
Stopping praksis_nhn_nautobot_docs_1     ...
Stopping praksis_nhn_nautobot_redis_1    ...
Stopping praksis_nhn_nautobot_postgres_1 ...
Stopping praksis_nhn_nautobot_worker_1   ... done
Stopping praksis_nhn_nautobot_nautobot_1 ... done
Stopping praksis_nhn_nautobot_postgres_1 ... done
Stopping praksis_nhn_nautobot_redis_1    ... done
Stopping praksis_nhn_nautobot_docs_1     ... done
Removing praksis_nhn_nautobot_worker_1   ...
Removing praksis_nhn_nautobot_nautobot_1 ...
Removing praksis_nhn_nautobot_docs_1     ...
Removing praksis_nhn_nautobot_redis_1    ...
Removing praksis_nhn_nautobot_postgres_1 ...
Removing praksis_nhn_nautobot_postgres_1 ... done
Removing praksis_nhn_nautobot_docs_1     ... done
Removing praksis_nhn_nautobot_worker_1   ... done
Removing praksis_nhn_nautobot_redis_1    ... done
Removing praksis_nhn_nautobot_nautobot_1 ... done
Removing network praksis_nhn_nautobot_default
```
...
So for example, our app is named `praksis-nhn-nautobot`, the command would most likely be `docker logs praksis_nhn_nautobot_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("praksis_nhn_nautobot")
namespace.configure(
    {
        "praksis_nhn_nautobot": {
            ...
...
Or set the `INVOKE_PRAKSIS_NHN_NAUTOBOT_PYTHON_VER` variable.
...
Or set the `INVOKE_PRAKSIS_NHN_NAUTOBOT_NAUTOBOT_VER` variable.
...
In the package source, there is the `praksis_nhn_nautobot/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
